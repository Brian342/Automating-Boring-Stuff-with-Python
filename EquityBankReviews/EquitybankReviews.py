...
LastPageFile = "last_page_Equity.txt"
Csv_File = "EquityReviews.csv"
...
driver.get(
    f"https://www.glassdoor.com/Reviews/Equity-Bank-Limited-Reviews-E422021_P{start_page}.htm?filter.iso3Language=eng"
)
